...
var module = angular.module('DomainCoder.ng.ConceptualFormEditor', ['DomainCoder.Core', 'DomainCoder.Model.Entity', 'DomainCoder.ng.ContextEditor', 'ConceptualForm.Core', 'ConceptualForm.Mapper'])
.config(function () {
});
